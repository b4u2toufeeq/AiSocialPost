          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formFieldLabel: "text-slate-355 text-xs font-semibold",
                formFieldInput: "bg-slate-955/50 border-slate-800 text-slate-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all",
